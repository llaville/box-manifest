...
=== "Command"
    ...
    ```shell
    box-manifest make -r console.txt -r manifest.txt stub
    ```
...
>
>     ```shell
>     box-manifest make -r console.txt -r manifest.txt --template resources/empty_stub.template --output-stub my-stub.php stub
>     ```
>
> === "Output"
>
...
>     <?php
>
>     // empty stub template @generated by BOX Manifest 4.x-dev@3eff4eb
>
>
>
>     // No PHAR config
